...
export function register(server) {
  ...
  server.tool(
    ...
    "ASYNC: a fresh call may return a run_id immediately and keep running in the background -- do NOT poll in a tight loop. Go do other parts of your task and check back later by calling again with resume_run_id. Still required eventually: only a resume_run_id call retrieves the final answer, and it's also what recovers a stalled background chain -- don't skip checking back entirely.",
    {
